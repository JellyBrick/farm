...
impl Displayable for Template {
  fn display_text(&self) -> &'static str {
    match self {
      ...
      Template::Tauri2(None) => "\x1b[38;2;255;137;54mTauri2 - (https://tauri.app/)\x1b[39m",
      Template::Tauri(None) => "\x1b[38;2;255;137;54mTauri - (https://v1.tauri.app/)\x1b[39m",
      Template::Tauri2(Some(sub_template)) => match sub_template {
        TauriSubTemplate::React => "\x1b[38;2;255;215;0mTauri2 with React\x1b[39m",
        TauriSubTemplate::Vue => "\x1b[38;2;255;215;0mTauri2 with Vue\x1b[39m",
        TauriSubTemplate::Vanilla => "\x1b[38;2;255;215;0mTauri2 with Vanilla\x1b[39m",
        TauriSubTemplate::Svelte => "\x1b[38;2;255;215;0mTauri2 with Svelte\x1b[39m",
        TauriSubTemplate::Solid => "\x1b[38;2;255;215;0mTauri2 with Solid\x1b[39m",
        TauriSubTemplate::Preact => "\x1b[38;2;255;215;0mTauri2 with Preact\x1b[39m",
      },
